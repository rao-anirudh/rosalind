mass = {"A": 71.03711, "C": 103.00919, "D": 115.02694, "E": 129.04259, "F": 147.06841, "G": 57.02146, "H": 137.05891,
...
with open("C:\\Users\\anira\\Desktop\\rosalind_prtm.txt", mode="r") as f:
    protein = f.read().replace("\n", "")
    weight = 0
    for amino_acid in protein:
        weight += mass[amino_acid]
    print(f"\nWeight: {weight:.3f}")
    f.close()
